...
CREATE TABLE `alugueis` (
  ...
  `ID_UNIDADE_DEVOLUÇÃO` int NOT NULL,
  PRIMARY KEY (`idAluguel`),
  KEY `ID_CLIENTE_idx` (`ID_CLIENTE`),
  KEY `ID_CARRO_idx` (`ID_CARRO`),
  KEY `ID_UNIDADE_RETIRADA_idx` (`ID_UNIDADE_RETIRADA`),
  KEY `ID_UNIDADE_DEVOLUÇÃO_idx` (`ID_UNIDADE_DEVOLUÇÃO`),
  CONSTRAINT `ID_CARRO` FOREIGN KEY (`ID_CARRO`) REFERENCES `carros` (`idCarro`),
  CONSTRAINT `ID_CLIENTE` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `clientes` (`idCliente`),
  CONSTRAINT `ID_UNIDADE_DEVOLUÇÃO` FOREIGN KEY (`ID_UNIDADE_DEVOLUÇÃO`) REFERENCES `unidades` (`idUnidade`),
  CONSTRAINT `ID_UNIDADE_RETIRADA` FOREIGN KEY (`ID_UNIDADE_RETIRADA`) REFERENCES `unidades` (`idUnidade`)
