...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(numeros);
        numeros.removeIf(numero -> numero == 8);
        System.out.println(numeros);

        /** funcoes lambdas */

        var todosAlunos = new ArrayList<>
                (List.of(
                new Aluno("jorge", 3.5),
                new Aluno("maria", 5.5),
        ...
        List<Aluno> aprovados = todosAlunos.stream().filter((a) -> a.nota() >= 5).collect(Collectors.toList());
        ...
        aprovados.sort(Comparator.comparing(Aluno::nota).reversed().thenComparing(Aluno::nome));
        System.out.println(aprovados);
        //Comparator
    }
}